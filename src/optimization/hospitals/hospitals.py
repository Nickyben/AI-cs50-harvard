...
class Space:
    ...
    def get_cost(self, hospitals):
        ...
        cost = 0
        for house in self.houses:
            # increasing the cost by the closest(min distance) hospital, for each house
            cost += min(
                # 0=>row, 1=>col. Basically adding the horizontal and vertical distance
    ...
    def get_neighbors(self, row, col):
        ...
        for r, c in candidates:
            # skip if the there's a house or hospital on this coordinate
            if (r, c) in self.houses or (r, c) in self.hospitals:
                continue
            # only consider coordinates within our space
        ...
        while maximum is None or count < maximum:
            ...
            for hospital in self.hospitals:
                ...
                for replacement in self.get_neighbors(*hospital):
                    ...
                    # neighbor here means node/state neighbor not individual hospital neighbor
            ...
            # None of the neighbors are better than the current state, ie this current state is the local best
